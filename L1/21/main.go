...
//мы захотели сделать рассылку об акциях на Wildberries подписчикам
func main() {

	var servers []GetAds //все опрашиваемые сервера. слайс серверов, реализующих метод GetAds который возвращает нам ответ с сервера в виде объявления об акциях
